...
if ( ! function_exists('verify_server'))
{
	function verify_server()
	{
		...
		$output = '<table class="table table-striped">';
			$output.= '<thead>';
				$output.= '<tr>';
					$output.= '<th class="span3">Component</th>';
					$output.= '<th class="span2">Required</th>';
					$output.= '<th class="span2">Actual</th>';
					$output.= '<th class="span1">Result</th>';
				$output.= '</tr>';
			$output.= '</thead>';
