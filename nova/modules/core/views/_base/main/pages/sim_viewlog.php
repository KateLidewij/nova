...
<div class="btn-toolbar">
	...
	<?php if ($edit_valid): ?>
		<div class="btn-group">
			<?php echo anchor('manage/logs/edit/'.$id, img(Location::img('icon-edit.png', $this->skin, 'main')), array('class' => 'btn'));?>
		</div>
	<?php endif;?>
	...
	<div class="btn-group">
		...
		<?php if (Auth::is_logged_in()): ?>
			<a class="btn" href="#" id="add_comment" rel="facebox" data-id="<?php echo $id;?>"><?php echo img(Location::img('comment-add.png', $this->skin, 'main'));?></a>
		<?php endif;?>
	</div>

	<div class="btn-group">
		<?php echo anchor('feed/logs', img(Location::img('feed.png', $this->skin, 'main')), array('class' => 'btn'));?>
	</div>
</div>
