...
<table class="table table-striped table-bordered">
	...
	<tbody>
		<tr>
			...
			<td class="align-center span4"><?php echo $label['avgposts'];?><sup>&dagger;</sup></td>
			<td class="span3 lead"><?php echo $avg_posts['current'];?></td>
		</tr>
		<tr>
			<td class="span3 lead"><?php echo $avg_logs['previous'];?></td>
			<td class="align-center span4"><?php echo $label['avglogs'];?><sup>&dagger;</sup></td>
			<td class="span3 lead"><?php echo $avg_logs['current'];?></td>
		</tr>
		<tr>
			<td class="span3 lead"><?php echo $avg_totals['previous'];?></td>
			<td class="align-center span4"><?php echo $label['avgentries'];?><sup>&dagger;</sup></td>
			<td class="span3 lead"><?php echo $avg_totals['current'];?></td>
		</tr>
		<tr>
			<td class="span3 lead">&mdash;</td>
			<td class="align-center span4"><?php echo $label['paceposts'];?><sup>&Dagger;</sup></td>
			<td class="span3 lead"><?php echo $pace['posts'];?></td>
		</tr>
		<tr>
			<td class="span3 lead">&mdash;</td>
			<td class="align-center span4"><?php echo $label['pacelogs'];?><sup>&Dagger;</sup></td>
			<td class="span3 lead"><?php echo $pace['logs'];?></td>
		</tr>
		<tr>
			<td class="span3 lead">&mdash;</td>
			<td class="align-center span4"><?php echo $label['pacetotal'];?><sup>&Dagger;</sup></td>
